...
const skills = [
  ...
  { name: 'C/C++', icon: Code, color: 'text-green-400' },
  ...
  { name: 'Data Analytics', icon: Cpu, color: 'text-cyan-400' },
];
            ...
            <div className="skills-grid">
              ...
              <div className="grid grid-cols-4 gap-6">
                {skills.map((skill, index) => (
                  <div
                    key={skill.name}
                    className="skill-item glass-card p-4 rounded-xl text-center group cursor-pointer"
                  >
                    <skill.icon 
                      size={40} 
                      className={`${skill.color} mx-auto mb-2 skill-icon group-hover:scale-110 transition-transform duration-300`}
                    />
